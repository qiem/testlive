...
(function ($) {
	...
	function setupOutput() {
		...
		var $exportButton = $(
			'<a href="' + customizerResetObj.customizerUrl + '?action=customizer_export&nonce=' + customizerResetObj.nonces.export + '" class="customizer-export-import customizer-export-link"><img alt="' + customizerResetObj.buttons.export.text + '" src="' + customizerResetObj.pluginUrl + '/assets/images/export.svg"><span class="customizer-export-import-hint">' + customizerResetObj.buttons.export.text + '</span></a>'
		);

		var $importButton = $(
			'<a href="" class="customizer-export-import customizer-import-trigger"><img alt="' + customizerResetObj.buttons.import.text + '" src="' + customizerResetObj.pluginUrl + '/assets/images/import.svg"><span class="customizer-export-import-hint">' + customizerResetObj.buttons.import.text + '</span></a>'
		);
