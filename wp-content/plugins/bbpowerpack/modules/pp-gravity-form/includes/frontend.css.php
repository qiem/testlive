...
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .pp-gf-content .gform_wrapper .gform_title,
...
FLBuilderCSS::typography_field_rule(
	array(
		...
		'selector'     => ".fl-node-$id .pp-gf-content .gform_wrapper span.gform_description,
...
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gform_title,
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-gf-content .form-title {
...
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper span.gform_description,
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-gf-content .form-description {
...
.fl-builder-content .fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield .gfield_label {
...
FLBuilderCSS::responsive_rule(
	array(
		'settings'     => $settings,
		'setting_name' => 'radio_checkbox_font_size',
		'selector'     => ".fl-node-$id .pp-gf-content .gform_wrapper ul.gfield_radio li label, .fl-node-$id .pp-gf-content .gform_wrapper .gfield_radio label, .fl-node-$id .pp-gf-content .gform_wrapper ul.gfield_checkbox li label, .fl-node-$id .pp-gf-content .gform_wrapper .gfield_checkbox label, .fl-node-$id .pp-gf-content .gform_wrapper .ginput_container_consent label",
		'prop'         => 'font-size',
		'unit'		   => 'px',
	)
);
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input::-webkit-input-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input:-moz-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input::-moz-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input:-ms-input-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield textarea::-webkit-input-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield textarea:-moz-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield textarea::-moz-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield textarea:-ms-input-placeholder {
	color: <?php echo pp_get_color_value( $settings->gf_input_placeholder_color ); ?>;
}
<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']):focus,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield select:focus,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield textarea:focus {
	border-color: <?php echo $settings->input_field_focus_color ? pp_get_color_value( $settings->input_field_focus_color ) : ''; ?>;
}

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .top_label input.medium,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .top_label select.medium {
	width: <?php echo ( 'true' === $settings->input_field_width ) ? '100%' : '49%'; ?> !important;
}

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper textarea.medium {
	width: <?php echo ( 'true' === $settings->input_field_width ) ? '100% !important;' : ';'; ?>
}

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_complex .ginput_full input[type="text"],
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_complex  input[type="text"] {
	width: <?php echo ( 'true' === $settings->input_field_width ) ? '100%' : '97.5%'; ?> !important;
}

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_complex .ginput_right {
	margin-left: 0 !important;
}

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_complex .ginput_right input,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_complex .ginput_right select {
	width: <?php echo ( 'true' === $settings->input_field_width ) ? '100% !important;' : ';'; ?>
}
...
<?php if ( 'yes' === $settings->radio_cb_style ) : // Radio & Checkbox ?>
	/* Radio & Checkbox */
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:focus,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:focus,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:focus,
	...
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:focus,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:focus:before {
	...
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:focus,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:focus:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox],
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:focus,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:focus:before {
		<?php if ( $settings->radio_cb_radius >= 0 ) : ?>
	...
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:checked:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_radio input[type=radio]:focus:checked:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:checked:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_checkbox input[type=checkbox]:focus:checked:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:checked:before,
	.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .ginput_container_consent input[type=checkbox]:focus:checked:before {
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield input[type=file] {
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .validation_error,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gform_validation_errors,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gform_validation_errors > h2,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper li.gfield.gfield_error,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper li.gfield.gfield_error.gfield_contains_required.gfield_creditcard_warning {
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield.gfield_error {
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield.gfield_error .gfield_label {
...
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_error .validation_message {
...
<?php if ( ! isset( $settings->validation_error_border_color ) || empty( $settings->validation_error_border_color ) ) { ?>
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper li.gfield.gfield_error.gfield_contains_required div.ginput_container,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper li.gfield.gfield_error.gfield_contains_required label.gfield_label {
	margin-top: 8px;
}
<?php } ?>

.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_error input:not([type='radio']):not([type='checkbox']):not([type='submit']):not([type='button']):not([type='image']):not([type='file']),
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_error .ginput_container select,
.fl-node-<?php echo $id; ?> .pp-gf-content .gform_wrapper .gfield_error .ginput_container textarea {
...
if ( isset( $settings->message_border_group ) && ! empty( $settings->message_border_group ) ) {
	FLBuilderCSS::border_field_rule(
		array(
			...
			'selector'     => ".fl-node-$id .pp-gf-content .gform_confirmation_wrapper",
		)
	);
}
...
if ( isset( $settings->message_typography ) && ! empty( $settings->message_typography ) ) {
	FLBuilderCSS::typography_field_rule(
		array(
			...
			'selector'     => ".fl-node-$id .pp-gf-content .gform_confirmation_wrapper .gform_confirmation_message",
		)
	);
}
?>
